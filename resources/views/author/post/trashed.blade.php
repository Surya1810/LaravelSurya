                                    ...
                                    @foreach($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @can ('Content.restore')
                                                <a href="{{ route('author.post.restore',$post->id) }}" class="btn btn-info waves-effect">
                                                ...
                                                <form id="delete-form-{{ $post->id }}" action="{{ route('author.post.kill', $post->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                @endcan
